      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xl text-slate-400 max-w-3xl mx-auto leading-relaxed">
              Transformez vos ressentis en <span className="text-slate-300 font-medium">psychographies</span> uniques 
              à travers un processus d'IA collaborative dans le Studio Psychographique.
            </p>
            <div className="flex flex-wrap justify-center gap-2 mt-4">
              <Badge variant="secondary" className="bg-blue-600/20 text-blue-300 border-blue-600">
                Studio Psychographique
              </Badge>
              <Badge variant="secondary" className="bg-purple-600/20 text-purple-300 border-purple-600">
                IA Collaborative
              </Badge>
              <Badge variant="secondary" className="bg-emerald-600/20 text-emerald-300 border-emerald-600">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <Card className="border-blue-700/30 bg-blue-950/20 backdrop-blur-sm hover:bg-blue-950/30 transition-colors">
            <CardContent className="p-8 text-center">
              ...
              <h3 className="font-semibold text-blue-200 mb-2">Saisie Initiale</h3>
              <p className="text-slate-400 text-sm leading-relaxed">
                Exprimez votre ressenti avec votre voix ou par écrit :
                <span className="block mt-2 text-slate-300">"Qu'est-ce qui vous habite maintenant ?"</span>
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-purple-700/30 bg-purple-950/20 backdrop-blur-sm hover:bg-purple-950/30 transition-colors">
            <CardContent className="p-8 text-center">
              ...
              <h3 className="font-semibold text-purple-200 mb-2">Labo Psychographique</h3>
              <p className="text-slate-400 text-sm leading-relaxed">
                L'IA génère 6 prompts d'enrichissement, choisissez jusqu'à 4 :
                <span className="block mt-2 text-slate-300">Paramètres • Style • Usage • Chaos</span>
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-emerald-700/30 bg-emerald-950/20 backdrop-blur-sm hover:bg-emerald-950/30 transition-colors">
            <CardContent className="p-8 text-center">
              ...
              <h3 className="font-semibold text-emerald-200 mb-2">Génération & Sauvegarde</h3>
              <p className="text-slate-400 text-sm leading-relaxed">
                Création finale avec preview temps réel :
                <span className="block mt-2 text-slate-300">Psychothèque • Partage • Votes</span>
              </p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="mt-16 max-w-2xl mx-auto">
          <blockquote className="text-slate-500 text-sm italic leading-relaxed border-l-2 border-blue-800 pl-4">
            "Le Studio Psychographique transforme le brainstorming en un voyage projectif et résonant, 
            où l'IA collaborative révèle les connexions créatives cachées dans vos ressentis les plus profonds."
          </blockquote>
        </div>
      </div>
    </div>
